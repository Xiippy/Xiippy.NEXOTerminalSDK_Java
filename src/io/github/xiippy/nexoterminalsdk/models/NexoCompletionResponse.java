...
/**
 * Represents a response to a NEXO completion request.
 */
public class NexoCompletionResponse {

    private String NexoCompletionResponseID;
    ...
    public String getNexoCompletionResponseID() {
        return NexoCompletionResponseID;
    }

    public void setNexoCompletionResponseID(String NexoCompletionResponseID) {
        this.NexoCompletionResponseID = NexoCompletionResponseID;
    }
